...
{if $snippet}
{if $paymentProcessor.payment_processor_type|strpos:'Novalnet' || $paymentProcessor.payment_processor_type|strpos:'Novalnet' === 0}
     {include file="CRM/Core/nntemplate.tpl" context="front-end"}
    {/if}
